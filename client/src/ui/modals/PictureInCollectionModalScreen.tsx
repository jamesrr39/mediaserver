...
import { CollectionType, CustomCollection, findCollectionFromTypeAndName } from "../../domain/Collection";
...
const collection = findCollectionFromTypeAndName(
  props.mediaFiles, type as CollectionType, name, props.customCollections);
if (!collection) {
...
return <MediaFileModal mediaFiles={mediaFiles} hash={hash} baseUrl={`/collections/${params.type}/${params.identifier}`} />;
}
